/*! ------------------------------------------------
 * Project Name: Olaoluwasamuel - Personal Portfolio & Resume HTML Template
 * Project Description: Show yourself brightly with Olaoluwasamuel - clean and creative portfolio and resume template!
...
$(function() {
  ...
  $.ajax({
    type: "POST",
    url: "https://script.google.com/macros/s/AKfycbzg05648NLoGLSSnrjZkqNGqE7yfAKh2Wz-8vPY5gp2x4ARHUxT12M3wo99a07RjR4L/exec", // Replace with your Google Apps Script URL
    contentType: "application/json",  // Set content type to JSON
    data: JSON.stringify(dataObject), // Send data as JSON
...
//   });
  ...
  //   $.ajax({
  //     type: "POST",
  //     url: "https://script.google.com/macros/s/AKfycbwWFsIbKoTFcOj3m9xXpMbHR3he9SR07JiY8vHldk9vrmV-FRGwHeAipA-o8FuXsMug/exec", // Replace with your Google Apps Script URL
  //     contentType: "application/json", // We are sending JSON
  //     data: JSON.stringify(dataObject), // Send data as a JSON object
  //     success: function(response) {
